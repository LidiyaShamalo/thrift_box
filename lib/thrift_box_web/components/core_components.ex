defmodule ThriftBoxWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ThriftBoxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ThriftBoxWeb.Gettext, "errors", msg, opts)
    end
  end
